...
# install stuff
sudo dnf install gnome-tweaks gnome-extensions-app code-insiders go npm brave-browser lpf-spotify-client discord papirus-icon-theme sassc zsh gawk youtube-dl flameshot gnome-shell-extension-appindicator gnome-shell-extension-caffeine tldr -y
# uninstall stuff
